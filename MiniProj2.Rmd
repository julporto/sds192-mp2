...
We can see from the graphs above that Montana(MT) has by far the most contributions per person (about 2000), and Minnesota(MN) the least (about 25). 
...
**Final Take-away:** Committees in Montana spend the most
