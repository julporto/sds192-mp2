...
The difference between the most contributing state NC and the following state Georgia (GA) is quite big as almost 500 dollars, but the gaps between the least contributing state MN and the next less contributing states South Dakota (SD), Wisconsin (WI) is very small as less than 5 dollars. 
